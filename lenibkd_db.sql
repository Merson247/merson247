...
(1, 'lnabire.png', 'PEMERINTAH KABUPATEN NABIRE', 'BADAN KEPEGAWAIAN DAERAH', 'Jl. Pembangunan No. 01', '-', 'http://www.bkd.bengkuluprov.go.id', '-', 'GUBERNUR BENGKULU', 'KEPALA BADAN KEPEGAWAIAN DAERAH', '198206152014091001', 100),
(2, 'lnabire_ab.png', 'PEMERINTAH KABUPATEN NABIRE', 'SEKRETARIAT DAERAH', 'Jl. Pembangunan No. 01', '-', 'http://www.bengkuluprov.go.id', '-', 'GUBERNUR BENGKULU', 'KEPALA SEKRETARIAT DAERAH', '196504052014091006', 110);
